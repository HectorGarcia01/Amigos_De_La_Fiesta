<?php
    ...
    if($Verificar_Usuario> 0){//en el caso que exista 
        ?> <script language = 'javascript'>
            alert("Lo siento, ya existe un usuario con el mismo DPI regitrado!!! Por favor intente de nuevo...");
            window.location = '/AMIGOS-DE-LA-FIESTA/RegistroUsuario2.php';
            </script> '; <?php
    }
    //para validar si ya hay un nombre de usuario con el ingresado
            ...
            if($TipoUsuario == 'DBA' || $TipoUsuario == 'Usuario'){//si hay tipo de usuario insertamos datos
                ...
                if($conn -> query($insert_usuario)===TRUE){
                    ?> <script language = 'javascript'>
                        ...
                        window.location = '/AMIGOS-DE-LA-FIESTA/loading3.html';
                        </script> '; <?php
                }
                else{
                    ?> <script language = 'javascript'>
